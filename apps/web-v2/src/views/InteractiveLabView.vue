  ...
  <div class="flex flex-col h-full overflow-hidden bg-surface-0">
    ...
    <div class="z-40 px-4 pt-2 sm:pt-4 pb-2 shrink-0">
      <header class="glass-v3 max-w-6xl mx-auto rounded-full px-4 sm:px-6 py-2.5 transition-all duration-500 shadow-2xl relative flex items-center justify-between border border-white/10">
        <div class="flex items-center gap-2">
          <button @click="goHome" class="p-2 rounded-full hover:bg-white/10 text-text-secondary transition-colors" title="返回首页">
          ...
          <h1 class="text-sm font-black text-text-primary truncate uppercase">互动实验室</h1>
        </div>
        ...
        <div class="flex items-center gap-2">
          <div class="hidden sm:flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
            ...
            <span class="text-[8px] font-black text-text-tertiary uppercase tracking-widest">5 实验已上线</span>
          </div>
        </div>
      </header>
    </div>
    ...
    <main class="flex-1 overflow-y-auto custom-scrollbar">
      <div class="max-w-6xl mx-auto p-4 sm:p-10 space-y-8 sm:space-y-12">
        ...
        <!-- Features Grid: Optimized for iOS (2-column on mobile) -->
        <section class="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-8 pb-10">
          <button 
            ...
            class="group relative flex flex-col p-4 sm:p-8 rounded-[28px] sm:rounded-[40px] glass-v3 border border-white/5 shadow-xl transition-all duration-500 hover:-translate-y-2 hover:border-accent/30 text-left overflow-hidden active:scale-95 animate-in fade-in slide-in-from-bottom-4"
          ...
          >
            ...
            <div class="flex items-start justify-between mb-4 sm:mb-10">
              ...
              <span class="px-1.5 py-0.5 rounded-md bg-white/5 border border-white/10 text-[7px] sm:text-[8px] font-black uppercase tracking-widest text-text-tertiary">
                {{ item.tag }}
              </span>
            </div>

            <div class="space-y-1 sm:space-y-3 mt-auto">
            ...
            <div class="mt-4 sm:mt-10 flex items-center justify-between relative z-10">
              <div class="flex items-center gap-1.5">
                <div class="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-accent animate-pulse shadow-[0_0_8px_rgba(var(--color-accent-rgb),0.6)]"></div>
              ...
              <div class="w-6 h-6 sm:w-9 sm:h-9 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-accent group-hover:text-white transition-all shadow-inner">
        ...
        <!-- Experimental Note: Compact for mobile -->
        <div class="p-5 sm:p-6 rounded-[28px] bg-accent/5 border border-accent/10 flex items-start gap-3 sm:gap-4 max-w-2xl mx-auto opacity-60 hover:opacity-100 transition-opacity">
