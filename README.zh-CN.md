...
- OpenCode profiles：`5.5 Pro`、`5.5 Multi-Agent`、`OMO`、`Raw`，并写入 repo-local health feedback
...
```bash
curl -fsSL https://raw.githubusercontent.com/CtriXin/multi-model-switch/v3.2.2/install.sh | bash -s --
```
