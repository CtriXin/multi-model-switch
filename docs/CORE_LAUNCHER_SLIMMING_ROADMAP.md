...
- Treat `mms_core.py`, `mms_launchers.py`, `mms_display/tui.py`, `mms_runtime/bridge.py`, `mms_runtime/account_state.py`, `mms_session/index.py`, `mms_registry/adapter_registry.py`, and `mms` as protected surfaces.
