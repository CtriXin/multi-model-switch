...
- Treat `mms_core.py`, `mms_launchers.py`, `mms_tui.py`, `mms_bridge.py`, `mms_account_state.py`, `mms_session_index.py`, `mms_adapter_registry.py`, and `mms` as protected surfaces.
