...
_consumer_bundle_status_rows = partial(_config_reports.consumer_bundle_status_rows, localize=_L)
_consumer_bundle_status_report_payload = partial(_config_reports.consumer_bundle_status_report_payload, localize=_L)
_registry_v2_save_plan_rows = partial(_config_reports.registry_v2_save_plan_rows, localize=_L)
_registry_v2_save_plan_report_payload = partial(_config_reports.registry_v2_save_plan_report_payload, localize=_L)
_preview_doctor_report_payload = partial(_config_reports.preview_doctor_report_payload, localize=_L)
_config_v2_promotion_plan_report_payload = partial(_config_reports.config_v2_promotion_plan_report_payload, localize=_L)
_config_v2_release_readiness_report_payload = partial(_config_reports.config_v2_release_readiness_report_payload, localize=_L)
_model_source_status_tui_payload = partial(_config_reports.model_source_status_tui_payload, localize=_L)
...
def _load_preview_runtime_config_from_latest_bundle():
    from mms_config.preview_runtime import load_preview_runtime_config_from_latest_bundle

    return load_preview_runtime_config_from_latest_bundle(
        config_dir=PRIMARY_CONFIG_DIR,
        preview_root_mode=_preview_root_mode,
        default_provider_id=DEFAULT_PROVIDER_ID,
        mode_all=MODE_ALL,
        probe_async_refresh_after=_PROBE_ASYNC_REFRESH_AFTER,
        probe_async_min_interval=_PROBE_ASYNC_MIN_INTERVAL,
        normalize_model_id_list=_normalize_model_id_list,
        normalize_supported_clis=_normalize_supported_clis,
    )
...
def _core_command_handlers():
    from mms_commands.core_handlers import build_core_command_handlers_from_module

    return build_core_command_handlers_from_module(sys.modules[__name__])
