...
- OpenCode Agent work split: GPT-5.5 coordinates/final-reviews, GPT-5.4 handles long-running implementation, and domestic models stay read-only for exploration, bug-hunt, and vision/context checks
