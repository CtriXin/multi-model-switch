...
| 我现在该装哪个版本 | [§2 装哪个版本](#2-装哪个版本30-秒决策) |
...
如果你只有 30 秒: 装 stable（`bash install.sh`）→ 浏览器打开 → 加第一个通道 → 跑起来。如果你不知道 stable 是什么意思, 看 [§2 装哪个版本](#2-装哪个版本30-秒决策)。
