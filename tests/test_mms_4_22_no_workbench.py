...
# This guard belongs to the 4.x stable product line; 5.x deliberately includes Bots.
pytestmark = pytest.mark.skipif(int(VERSION.split(".")[0]) >= 5, reason="4.x stable-line boundary")
