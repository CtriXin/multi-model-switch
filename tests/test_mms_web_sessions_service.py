...
def test_launch_success_shape(tmp_path, seeded_seam):
    ...
    assert session["capabilities"] == {"send": True, "stop": True, "approve": False, "steer": True, "queueControl": True, "sideQuestions": True}
...
def test_persistence_and_restart_snapshot(tmp_path, seeded_seam):
    ...
    assert listed[0]["capabilities"] == {"send": False, "stop": False, "approve": False, "steer": False, "queueControl": False, "sideQuestions": True}
