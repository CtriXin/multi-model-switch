...
def opencode_committee_agent_configs(agent_models, *, roster_config=None):
    ...
    committee_policy_contract = (
        ...
        "chat_only plus readonly unless the user or local project rules explicitly "
        "authorize scoped artifacts, formal votes, decision files, checker runs, "
        "or implementation. Keep this separate from Debate: do not run blind "
    ...
    agents = {
        ...
        "committee-host-pro": {
            ...
            "prompt": (
                ...
                "mode contract plus the committee_policy fields "
