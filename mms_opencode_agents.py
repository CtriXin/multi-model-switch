...
def opencode_committee_agent_configs(agent_models, *, roster_config=None, agent_policies=None):
    ...
    host_prompt = (
        ...
        "also include 模型耗时 / Model Timing with return order, elapsed time, "
        "and relative speed ratio. This section is for the requester, not the "
        "copy-forward packet. (2) 可直接"
        ...
        "verification, member findings or ballots, model timing, tally and "
        "consensus, disagreements, risks, formal artifact status, and provenance. "
        "Do not include scorecard, meta commentary, or host private advice in "
        "this packet. (3) Host 建议 / "
        ...
        "committee-host-pro": {
            ...
            "prompt": _prompt_with_tool_policy(
                (
                    ...
                    "task-local subagent scorecard and model timing, and "
                    "summarize only evidence-backed conclusions. Send the unchanged mission block "
