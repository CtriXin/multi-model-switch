...
def opencode_committee_agent_configs(agent_models, *, roster_config=None, agent_policies=None):
    ...
    committee_synthesis_contract = (
        ...
        "undifferentiated bullet list. Inside Human Notes, use visible "
        "subsections in this order: 结论 / Decision; 已核验 / Direct "
        "Verification; 需要人看的问题 / Findings; 风险与分歧 / Risks & "
        "Disagreements; 模型耗时 / Model Timing; Scorecard. "
        "(2) 可直接复制转发 / Copy-forward Packet: keep it clean and "
        "self-contained. Start this packet with 追踪块 / Trace containing the "
        "same current MMS-MISSION block, then include the goal, committee_policy, "
        "assignments, direct verification, member findings or ballots, model "
        "timing, tally and consensus, disagreements, risks, formal artifact "
        "status, and provenance. Do not include scorecard, meta commentary, or "
        "host private advice in this packet. (3) Host 建议 / Host Recommendation: "
