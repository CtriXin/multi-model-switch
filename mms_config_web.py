...
<header>
  <div>
    <h1>MMS 配置中心</h1>
    <p class="lead">管理 AI 通道、模型列表、Fallback 与运行参数。所有更改在保存前均可预览。</p>
  </div>
...
<div class="shell">
  ...
  <main class="content">
    ...
    <section class="panel" data-section="channel">
      <h2>通道配置</h2>
      <p>添加并编辑 AI 服务通道。填写名称、接口地址和 API Key 即可开始使用。Key 只会通过 POST 发送，不会回显。</p>
    ...
    <section class="panel" data-section="test">
      <h2>模型测试</h2>
      <p>快速测试模型是否可用。支持 Ping 检测和简单对话测试。</p>
      <div class="grid">
    ...
    <section class="panel" data-section="fallback">
      <h2>Fallback 设置</h2>
      <p>设置备用模型和 Vision 辅助通道。当主模型失败或需要处理图片时自动切换。</p>
      <div class="grid">
    ...
    <section class="panel" data-section="runtime">
      <h2>运行默认值</h2>
      <p>配置默认命令行工具、编码模型和 OpenCode 智能体分工。</p>
      <div class="grid">
        <div class="card span5">
    ...
    <section class="panel" data-section="save">
      <h2>保存 / 审计</h2>
      <p>保存前预览变更，确认后自动备份并写入配置。API Key 不会出现在日志中。</p>
      <div class="grid">
        <div class="card span5">
          <div class="btns">
          ...
          <div class="check" style="margin-top:12px">
            <input id="confirmSave" type="checkbox"><span>我已检查摘要、风险和 diff，同意写入配置</span>
          </div>
          <label style="margin-top:12px">输入确认文字：保存配置</label>
          <input id="confirmPhrase" placeholder="保存配置">
        ...
        <div class="card span12">
          ...
          <div id="reviewSummary">
            <p class="muted">点击「生成保存预览」后，这里会先列出 URL、隐藏模型、fallback、OpenCode 和风险变化。</p>
          </div>
        </div>
        <div class="span12">
