...
Current release: `v4.19.1` on the `dev` track. Stable and canary tracks keep
...
```bash
curl -fsSL https://raw.githubusercontent.com/CtriXin/multi-model-switch/main/install.sh | bash -s -- --ref v4.19.1
