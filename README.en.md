...
> **Note**: switching lines currently requires re-running the installer from a
> terminal. Pilot's update surface has no "switch to preview" control yet. That
> is a known gap, not the intended design.
