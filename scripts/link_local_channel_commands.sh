...
case "$MAIN_ROOT_DEFAULT" in
  */.worktrees/*) MAIN_ROOT_DEFAULT="${MAIN_ROOT_DEFAULT%%/.worktrees/*}" ;;
esac
...
DEV_ROOT="${MMS_DEV_ROOT:-$MAIN_ROOT_DEFAULT/.worktrees/dev}"
CANARY_ROOT="${MMS_CANARY_ROOT:-$MAIN_ROOT_DEFAULT/.worktrees/canary}"
STABLE_ROOT="${MMS_STABLE_ROOT:-$MAIN_ROOT_DEFAULT/.worktrees/stable-v3.3-no-db}"
